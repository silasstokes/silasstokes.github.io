...
2. Get vendor dev kit presenting to computer as a pointing peripheral. Using zephyr.
3. Add another vendor dev kit and create a compositor so that the 2 dev kits act as one.
